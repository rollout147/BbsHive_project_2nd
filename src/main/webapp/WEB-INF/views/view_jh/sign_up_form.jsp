...
<link rel="stylesheet" type="text/css" href="/css/jh_sign_up_form.css">
...
<div class="body">
    ...
    <form method="post" name="frm" action="/view_jm/join" onsubmit="return chkValue();">
        ...
        <div class="form-group">
            ...
            <input type="text" id="user_tel" name="user_tel" oninput="hypenTel(this)" maxlength="13" required>
        ...
        <div class="form-group">
            ...
            <input type="text" id="user_zipcode" name="user_zipcode" required>
        ...
        <div class="form-group">
            ...
            <input type="text" id="user_addr1" name="user_addr1" required>
        ...
        <div class="form-group">
            ...
            <input type="text" id="user_addr2" name="user_addr2" required>
        ...
        <div class="form-group">
            <div class="moveBtn">
                <a href="/view_jm/buyerJoinAgree"><button id="backBtn" onclick="history.back();">이전</button></a>
